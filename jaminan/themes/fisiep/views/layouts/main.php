                        ...
                        <div class="site-sidebar">
                            ...
                            $items = array(
                              ...
                              array(
                                ...
                                'sub' => array(
                                  array(
                                    'name' => 'Rekruitmen Mahasiswa',
                                    'link' => Yii::app()->getBaseUrl(true).'/RekruitmenMaba/getdata',
                                  ),
                                  array(
                                    'name' => 'Profil Mahasiswa & Lulusan',
                                    'link' => Yii::app()->getBaseUrl(true).'/RekruitmenMaba/getdata_profil',
                                  ),
                                  array(
                                    'name' => 'Evaluasi Lulusan',
                                    'link' => Yii::app()->getBaseUrl(true).'/RekruitmenMaba/getdata_evaluasi',
                                  ),
                                  array(
                                    'name' => 'Himpunan Alumni',
                                   'link' => Yii::app()->getBaseUrl(true).'/RekruitmenMaba/getdata_himpunan',
                                  )
                                )
                              ),
                              array(
                              ...
                              array(
                                ...
                                'sub' => array(
                                 ...
                                 array(
                                    'name' => 'Persyartan dan Pelaksanaan',
                                    'link' => Yii::app()->getBaseUrl(true).'/kurikulum/getdatapersyaratanpelaksanaan',
                                  ),
                                // array(
                                 ...
                                 array(
                                    ...
                                    'link' => Yii::app()->getBaseUrl(true).'/kurikulum/getdatamonitoring',
                                  ),
                               array(
                                    'name' => 'Upaya Peningkatan Kemampuan Lulusan',
                                    'link' => Yii::app()->getBaseUrl(true).'/kurikulum/getdatakemampuanlulusan',
                                  ),
                                 array(
                                    'name' => 'Upaya Peningkatan Suasana Akademik',
                              ...
                              array(
                                ...
                                'sub' => array(
                                  array(
                                    'name' => 'Penelitian Dosen Tetap',
                                    'link' => Yii::app()->getBaseUrl(true).'/penelitian/getdataagenda',
                                  ),
                                  array(
                                    'name' => 'Pengabdian Kepada Masyarakat',
                                    'link' => Yii::app()->getBaseUrl(true).'/penelitian/getdata_pkm',
                                  ),
                                  array(
                                    'name' => 'Kerjasama Dengan Instansi',
                                    'link' => Yii::app()->getBaseUrl(true).'/penelitian/getdatakerjasamadlm',
                                  ),
                                )
                              ),
                              array(
