...
<?php
	...
	<div class="span3">
		...
		<?php
			...
			$this->widget('zii.widgets.CMenu', array(
				'items'=>array(
					array('label'=>'Pengisi Borangs', 'url'=>array('/pengisiborang/admin')),
					array('label'=>'Standar 1', 'url'=>array('/visimisi/admin')),
					array('label'=>'Standar 2', 'url'=>array('/tatapamong/admin')),
					array('label'=>'Standar 3', 'url'=>array('/rekruitmenmaba/admin')),
					...
					array('label'=>'Standar 7', 'url'=>array('/agendadanpenelitia/admin')),
