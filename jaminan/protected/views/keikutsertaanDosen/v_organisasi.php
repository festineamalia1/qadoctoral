...
if($id_prodi == 1){
	...
	<p style="padding-left:25px;">
		Pengalaman Dosen Tetap sebagai keanggotaan pada lembaga-lembaga profesi dan ilmiah
	</p>
	...
	<p>
		4.5.5.1 Pengalaman Dosen Tetap sebagai keanggotaan pada organisasi/asosiasi profesi dan ilmiah
	</p>
	<?php
	if(empty($data)){
		?>
