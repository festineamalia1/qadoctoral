...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'jenis_pustaka',array('buku teks'=>'Buku teks lanjut','jurnal nas'=>'Jurnal nasional yang terakreditasi','jurnal inter'=>'Jurnal internasional','prosiding'=>'Prosiding','disertasi'=>'Disertasi'),array('prompt' => 'Pilih Jenis Pustaka')); ?>
	</div>
