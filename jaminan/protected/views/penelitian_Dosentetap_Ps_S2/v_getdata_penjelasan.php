...
$this->breadcrumbs=array(
	'Pendekatan dan Pemikiran Baru Penelitian Dosen',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Pendekatan dan Pemikiran Baru Penelitian Dosen</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_penjelasan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatapenjelasan"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdatapenjelasan").click(function()
  	{
  		var dataserialized = $('#form_penjelasan').serialize();
  		//$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataPenjelasan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatapenjelasan").trigger('click');
