...
/* @var $data Penelitian_Dosentetap_Ps_S2 */
?>
<?php /*
<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_penelitian_dosentetap_ps_s2')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_penelitian_dosentetap_ps_s2), array('view', 'id'=>$data->id_penelitian_dosentetap_ps_s2)); ?>
	<br />
