...
$this->breadcrumbs=array(
	'Judul dan hasil/dampak kegiatanpelayanan/pengabdian kepada masyarakat',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Judul dan hasil/dampak kegiatanpelayanan/pengabdian kepada masyarakat</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_pelayanan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatapelayanan"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdatapelayanan").click(function()
  	{
  		var dataserialized = $('#form_pelayanan').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataPelayanan",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatapelayanan").trigger('click');
