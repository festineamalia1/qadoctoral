...
?>
		...
		<thead>
			<tr>
				...
				<th rowspan="1" colspan="3">Jumlah Penelitian Dalam  Tahun Pelaksanaan</th>
				<th rowspan="2">Jumlah Penelitian Selama Tiga Tahun </th>
		...
		<div class="row-fluid">
			<div class="span12" style="text-align:right;">
				<a href="<?=Yii::app()->getBaseUrl(true)?>/penelitian_Dosentetap_Ps_s2/CetakPDFpenelitian/?id_prodi=<?=$id_prodi?>&id_administrasi=<?=$id_administrasi?>" target="_blank" class="btn btn-primary" value="Cetak Borang"> <i class="icon-print icon-white"></i> Cetak Borang</a>
			</div>
		</div>
<?
}
