...
$this->breadcrumbs=array(
	'Kerjasama dengan Instansi Dalam Negri',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Kerjasama dengan Instansi Dalam Negri</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_kerjasamadlm">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatakerjasamadlm"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdatakerjasamadlm").click(function()
  	{
  		var dataserialized = $('#form_kerjasamadlm').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataKerjasamadlm",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatakerjasamadlm").trigger('click');
