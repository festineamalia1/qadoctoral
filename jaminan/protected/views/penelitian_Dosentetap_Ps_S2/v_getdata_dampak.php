...
$this->breadcrumbs=array(
	'Penjelasan Dampak Penelitian Dosen',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Penjelasan Dampak Penelitian Dosen</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_dampak">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatadampak"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
