...
<?php
	// $model=new VisiMisi;
?>
<h1>Penelitian dan Judul Penelitian</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_penelitian">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatapenelitian"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdatapenelitian").click(function()
  	{
  		var dataserialized = $('#form_penelitian').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataPenelitian",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatapenelitian").trigger('click');
