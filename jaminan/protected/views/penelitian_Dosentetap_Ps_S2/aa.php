...
$this->breadcrumbs=array(
	'Hasil Karya Dosen yang memperoleh Hak Paten ',
);
?>
...
?>
<<<<<<< .mine
<h1>Hasil Karya Dosen </h1>
=======
<<<<<<< .mine
<h1>Hasil Karya Dosen yang memperoleh Hak Pate</h1>
=======
<h1>Hasil Karya Dosen yang Memperoleh Hak Paten</h1>
>>>>>>> .r235
>>>>>>> .r234
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_judul">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatajudul"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
