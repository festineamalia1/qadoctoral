	...
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	<li class="list_tab active"><a href="#tab1" class="a_tab" data-toggle="tab">Profil Mahasiswa dan Lulusan</a></li>
		    	<li class="list_tab "><a href="#tab3" class="c_tab" data-toggle="tab">Prestasi Mahasiswa</a></li>
		    	<li class="list_tab "><a href="#tab4" class="d_tab" data-toggle="tab">Mahasiswa 6 Tahun</a></li>
		  	</ul>
		    		...
		    		<!-- Start Tab 1 -->
		      		<div class="row-fluid">
						<div class="span12" style="padding:20px;">
							<form class="form-inline" method="post" id="form_profil">
							...
							<form class="form-inline" method="post" id="form_mhs6">
							   <label class="control-label" for="">Jurusan</label>
							    ...
							    <label class="control-label" for="">Tahun</label>
							      ...
							      <button type="button" class="btn btn-primary getdata_mhs6"><i class="icon-arrow-right icon-white"></i> Tampil</button>
							</form>
						</div>
					</div>
					<!-- END -->
...
$(function(){
  $(".getdata").click(function()
  	{
  		var dataserialized = $('#form_profil').serialize();
  		// $("#data").hide();
  		$.ajax({url:"sentdata_profil",
  			type:'POST',
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdata_mhs6").click(function()
  	{
  		var dataserialized = $('#form_mhs6').serialize();
  		// $("#data").hide();
  		$.ajax({url:"<?=Yii::app()->getBaseUrl(true)?>/DataMhs6thn/sentdata",
  			type:'POST',
  			data: dataserialized,
		   	beforeSend:function(){
