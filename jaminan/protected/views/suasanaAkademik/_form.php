...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'suasana_akademik'); ?>
		<?php //echo $form->textArea($model,'suasana_akademik',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'suasana_akademik'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'suasana_akademik',
                'editorTemplate'=>'full',
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'ketersediaan_kelengkapan'); ?>
		<?php //echo $form->textArea($model,'ketersediaan_kelengkapansarana_dana',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'ketersediaan_kelengkapan'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'ketersediaan_kelengkapan',
                'editorTemplate'=>'full',
                'htmlOptions'=>array('class'=>'input-xxlarge tinymce'),
                'options' => array(
	               'theme_advanced_buttons1' =>
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'interaksi_akademik'); ?>
		<?php //echo $form->textArea($model,'interaksi_akademik',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'interaksi_akademik'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'interaksi_akademik',
                'editorTemplate'=>'full',
                'htmlOptions'=>array('class'=>'input-xxlarge tinymce'),
                'options' => array(
	               'theme_advanced_buttons1' =>
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'upaya_ps'); ?>
		<?php echo $form->error($model,'upaya_ps'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'upaya_ps',
