...
$this->breadcrumbs=array(
	...
	'Detail Data Himpunan alumni '.$model->id_himpunans2,
);
...
$this->menu=array(
	...
	array('label'=>'Ubah data', 'url'=>array('update', 'id'=>$model->id_himpunans2)),
	array('label'=>'Hapus Data', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id_himpunans2),'confirm'=>'Are you sure you want to delete this item?')),
