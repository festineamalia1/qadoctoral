...
<?php if($id_prodi == 1){
	?>
	<p>
		4.3 Aktivitas Dosen Tetap Per Semester
	</p>
...
?>
	<p>
	4.3.3 Aktivitas dosen tetap dinyatakan dalam SKS rata-rata per semester pada satu tahun akademik terakhir, diisi dengan perhitungan sesuai SK Dirjen Dikti no. 48 tahun 1983 (12 SKS setara dengan 36 jam kerja per minggu)
	</p>
	<?php
	if(empty($data)){
		?>
	...
	<p class="keterangan">
		...
		**  sks manajemen dihitung sbb :<br>
		...
		- sekretaris jurusan / sekretaris pusat / sekretaris senat akademik/sekretaris senat universitas / sekretaris senat fakultas / kepala lab. atau studio / kepala balai / ketua PS 4 SKS<br>
		- sekretaris PS 3 SKS <br><br>
