...
<!-- tambahan -->
<?php echo "<b>Jelaskan sistem rekrutmen (termasuk persyaratan akademik dan pengalaman), penempatan, pembinaan, pengembangan dan pemberhentian dosen dan tenaga kependidikan untuk menjamin mutu penyelenggaraan program akademik.</b>";?><br><br>
	<?
...
<!-- end tambahan -->
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'pembinaan'); ?>
		<?php //echo $form->textArea($model,'pembinaan',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'pembinaan'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'pembinaan',
