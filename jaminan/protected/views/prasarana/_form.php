...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'kepemilikan',array('sendiri'=>'Sendiri','Sewa'=>'Sewa'),array('prompt' => 'Pilih Kepemilikan')); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'kondisi'); ?>
		<?php echo $form->error($model,'kondisi'); ?>
		<?php echo $form->dropDownList($model,'kondisi',array('Terawat'=>'Terawat','Tidak Terawat'=>'Tidak Terawat'),array('prompt' => 'Pilih Kondisi')); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'utilitas'); ?>
		<?php echo $form->error($model,'utilitas'); ?>
		<?php echo $form->textField($model,'utilitas',array('size'=>150,'maxlength'=>150)); ?>
	</div>
