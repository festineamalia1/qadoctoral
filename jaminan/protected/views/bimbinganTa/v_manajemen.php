	...
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab active"><a href="<?=Yii::app()->getBaseUrl(true)?>/BimbinganAkademik/admin" class="a_tab" data-toggle="tab">Pemb. Tesis</a></li>
		    	<li class="list_tab "><a href="<?=Yii::app()->getBaseUrl(true)?>/PelaksanaanbimbinganTa/admin" class="a_tab" data-toggle="tab">Pelaksanaan Bimb. Tesis</a></li>
