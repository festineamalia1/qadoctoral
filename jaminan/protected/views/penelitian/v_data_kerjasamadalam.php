<style type="text/css">
	...
	7.3   Kegiatan kerjasama dengan instansi lain dalam lima tahun terakhir
	</p>

	<p>
		7.3.1 Tuliskan instansi dalam negeri yang menjalin kerjasama* yang terkait dengan Program
		Studi/jurusan dalam lima tahun terakhir
	</p>
<?
if($id_prodi==1) {
?>
...
?>
	...
	<div class="row-fluid">
		<div class="span12" style="text-align:right;">
			<a href="<?=Yii::app()->getBaseUrl(true)?>/penelitian/CetakPDFkerjasamadalam/?<?=(isset($id_prodi))? 'id_prodi='.$id_prodi.'&' : ''?>id_administrasi=<?=$id_administrasi?>" target="_blank" class="btn btn-primary" value="Cetak Borang"> <i class="icon-print icon-white"></i> Cetak Borang</a>
		</div>
	</div>
<?php 
}
