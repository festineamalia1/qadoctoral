...
$this->breadcrumbs=array(
	'Judul dan Penelitian Dosen Melibatkan Mahasiswa',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Judul dan Penelitian Dosen Melibatkan Mahasiswa</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_topik">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatatopik"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
