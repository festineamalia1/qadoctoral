...
<p class="judul" style="font-weight:bold;">
	7.1  Penelitian Dosen Tetap yang Bidang Keahliannya Sesuai dengan PS dalam Lima Tahun Terakhir
			...
			<p>
				7.1.7  Sebutkan karya dosen dan atau mahasiswa program studi yang telah memperoleh hak paten/HaKI atau karya yang mendapat pengakuan/penghargaan dari lembaga nasional/ internasional, lima tahun terakhir.
				</p>
...
?>
		...
		<div class="row-fluid">
			<div class="span12" style="text-align:right;">
				<a href="<?=Yii::app()->getBaseUrl(true)?>/penelitian/CetakPDFkarya/?<?=(isset($id_prodi))? 'id_prodi='.$id_prodi.'&' : ''?>id_administrasi=<?=$id_administrasi?>" target="_blank" class="btn btn-primary" value="Cetak Borang"> <i class="icon-print icon-white"></i> Cetak Borang</a>
			</div>
		</div>
<?
	}
