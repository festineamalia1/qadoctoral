...
<p>
	7.1.6   Tuliskan dosen yang melakukan penelitian dengan melibatkan mahasiswa program magister untuk penelitian disertasinya, pada tahun akademik terakhir (TS).
</p>
<?php if($id_prodi == 1){
	?>
	...
	<table class="table table-bordered min">
		...
		<tbody>
			...
			<tr>
				...
				<td><?=$value['topik_penelitian_disertasi']?></td>
