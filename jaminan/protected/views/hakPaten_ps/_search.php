...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'lembaga_akreditasi'); ?>
		<?php echo $form->textField($model,'lembaga_akreditasi',array('size'=>60,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tingkat_akreditasi'); ?>
		<?php echo $form->textField($model,'tingkat_akreditasi',array('size'=>13,'maxlength'=>13)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tgl_publikasi'); ?>
