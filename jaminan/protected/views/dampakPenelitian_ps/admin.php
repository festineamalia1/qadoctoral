...
$this->breadcrumbs=array(
	...
	'Standar 7 (Penjelasan Dampak Penelitian)'=>array('index'),
	'Manajemen Data',
);
$this->menu=array(
...
$('.search-form form').submit(function(){
	$('#dampak-penelitian-ps-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manajemen Data Penjelasan Dampak Penelitian</h1>
<?
