...
?>
		...
		<table class="table table-bordered min">
			...
			<tr>
				...
				<td><?=$value['th_mulai_dlm']?></td>	
				<td><?=$value['th_akhir_dlm']?></td>	
				<td><?=$value['manfaat__dlm']?></td>	
			</tr>
			<?php
			}
			?>
		...
		<div class="row-fluid">
			<div class="span12" style="text-align:right;">
				<a href="<?=Yii::app()->getBaseUrl(true)?>/kerjasamaDlm_ps/CetakPDFkerjasama_dalam/?<?=(isset($id_prodi))? 'id_prodi='.$id_prodi.'&' : ''?>id_administrasi=<?=$id_administrasi?>" target="_blank" class="btn btn-primary" value="Cetak Borang"> <i class="icon-print icon-white"></i> Cetak Borang</a>
			</div>
		</div>
<?
} else {
