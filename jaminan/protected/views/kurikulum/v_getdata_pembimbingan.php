	...
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_pembimbingan">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary GetDataPembimbingan"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".GetDataPembimbingan").click(function()
  	{
  ...
  $(".getdatapembimbingan").trigger('click');
