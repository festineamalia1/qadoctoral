...
?>
	<p>5.4 Penelitian Disertasi</p>
	<p>
	5.3.1 Jelaskan sistem pembimbingan penelitian disertasi pada program studi ini, mencakup informasi tentang:  </p>
	...
	<p>2. Mekanisme penunjukan pembimbing (sebagai promotor, kopromotor, anggota) dan mahasiswa bimbingan</p>
	<?php
	if((empty($data))){
		?>
			<div class="alert alert-error">
