...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'sebagai',array('pakar'=>'Pakar','konsultan'=>'Konsultan','staf_ahli'=>'Staf Ahli', 'narasumber'=>'Narasumber' ),array('prompt' => 'Pengalaman Dosen Tetap Sebagai')); ?>
	</div>
