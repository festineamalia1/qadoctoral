...
?> 
	<p>
		4.6 Data dan Kompetensi Tenaga Kependidikan(Pengalaman Dosen Tetap)
	</p>
		...
		<?php
		if(empty($data['upaya_peningkatan_kompetensi'])){
			?>
				<div class="alert alert-error">
				  Maaf Data yang Anda inginkan masih dalam keadaan kosong. 
				</div>
		...
		<p style="border:1px solid black;padding:5px;">
			<?=$data['upaya_peningkatan_kompetensi']?>
		<p>
		<?php } ?>
		<div class="row-fluid">
...
?>
		<p>4.6  Data dan Kompetensi Tenaga kependidikan</p>
