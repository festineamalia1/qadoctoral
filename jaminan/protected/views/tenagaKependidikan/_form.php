...
<!-- tambahan -->
<?php echo "<b>Tuliskan data tenaga kependidikan  yang ada di PS, Jurusan, Fakultas atau PT yang melayani mahasiswa PS dengan mengikuti format tabel berikut.</b>";?><br><br>
	<?
...
<!-- end tambahan -->
	...
	<?php echo "<b>Jelaskan upaya yang telah dilakukan PS dalam meningkatkan kualifikasi dan kompetensi tenaga kependidikan. </b>";?><br><br>
