...
<p>
	6.4.1 Jelaskan sistem informasi dan fasilitas yang digunakan oleh program studi untuk proses pembelajaran (hardware, software, e-learning, perpustakaan, dll).
</p>
<?
if(empty($sistem) ){
	?>
...
<br>
<p>
	6.4.2 Beri tandan <img style="max-width:15px;padding-bottom:5px;" src="<?php echo Yii::app()->baseUrl;?>/images/centang.png"> (centang) pada kolom yang sesuai (hanya satu kolom) dengan aksesibilitas tiap jenis data, dengan mengikuti format tabel berikut :
</p>
