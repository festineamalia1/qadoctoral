...
/* @var $data CapaianDosen */
?>

<div class="view">
	<!--
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_capaian')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_capaian), array('view', 'id'=>$data->id_capaian)); ?>
	<br /> -->
