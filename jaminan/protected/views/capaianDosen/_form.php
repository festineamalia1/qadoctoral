...
<!-- tambahan -->
	<?php echo "<b>Sebutkan pencapaian prestasi/reputasi dosen tetap (misalnya prestasi dalam pendidikan, penelitian dan pelayanan/pengabdian kepada masyarakat) berupa hadiah dan penghargaan lainnya.</b>";?><br><br>
	<?
...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'bidang',array('pendidikan'=>'Pendidikan','penelitian'=>'Penelitian','pelayanan/pengabdian masyarakat'=>'Pelayanan / Pengabdian Masyarakat', 'lain-lain'=>'Lain-lain'),array('prompt' => 'Pilih Bidang Prestasi')); ?>
	</div>
