...
<?php echo $form->errorSummary($model,$header='<b>Kesalahan Pengisian Data : </b>',$footer='',$htmlOptions=array('class'=>'alert alert-error')); ?>
	...
	<!-- tambahan -->
<?php echo "<b>Tuliskan data jumlah reguler enam tahun terakhir (tidak termasuk mahasiswa transfer).</b>";?><br><br>
<?
...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'TS_jum',array('TS'=>'TS','TS1'=>'TS1','TS2'=>'TS2','TS3'=>'TS3','TS4'=>'TS4','TS5'=>'TS5'),array('prompt' => 'Pilih TS')); ?>
