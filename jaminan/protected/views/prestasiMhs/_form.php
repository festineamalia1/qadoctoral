...
<?
	...
	<div class="row">
		...
		<?php echo $form->labelEx($model,'id_mahasiswa'); ?>
		<?php echo $form->error($model,'id_mahasiswa'); ?>
		<?php echo $form->dropDownList($model, 'id_mahasiswa', CHtml::listData(
		MahasiswaS3::model()->findAll(), 'id_mhs_s3', 'nama_mhs_s3'),
...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tempat',array('placeholder'=>'Tempat Penyelengaraan')); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'jenis_prestasi'); ?>
		<?php echo $form->error($model,'jenis_prestasi'); ?>
		<?php echo $form->textArea($model,'jenis_prestasi',array('class'=>'input-xxlarge','size'=>50,'maxlength'=>50)); ?>
	</div>
