...
<div class="view">
	...
	<tr>
		...
		<td>
			: <?php echo CHtml::encode($data->relasi_mahasiswa->nama_mhs_s3); ?>
		</td>
	<tr>
	...
	<tr>
		<td>
			<b><?php echo CHtml::encode($data->getAttributeLabel('jenis_prestasi')); ?></b>
		</td>
		<td>
			: <?php echo CHtml::encode($data->jenis_prestasi); ?>
		</td>
	</tr>
