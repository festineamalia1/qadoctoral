...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'perkuliahan'); ?>
		<?php echo $form->textArea($model,'perkuliahan',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tugas_khusus'); ?>
		<?php echo $form->textArea($model,'tugas_khusus',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'penelitian'); ?>
		<?php echo $form->textArea($model,'penelitian',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'hasil_penelitian'); ?>
		<?php echo $form->textArea($model,'hasil_penelitian',array('rows'=>6, 'cols'=>50)); ?>
	</div>
