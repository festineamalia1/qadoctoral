	...
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	...
		    	<li class="list_tab "><a href="#tab2" class="b_tab" data-toggle="tab">Prestasi Mahasiswa</a></li>
		    	<li class="list_tab "><a href="#tab3" class="c_tab" data-toggle="tab">Mahasiswa 5 Tahun</a></li>
		  	</ul>
		    		...
		    		<!-- Start Tab 1 -->
		      		<div class="row-fluid">
						<div class="span12" style="padding:20px;">
							<form class="form-inline" method="post" id="form_jml">
...
$(function(){
  $(".getdata").click(function()
  	{
  		var dataserialized = $('#form_jml').serialize();
  		// $("#data").hide();
  		$.ajax({url:"sentdata",
  			type:'POST',
  			data: dataserialized,
