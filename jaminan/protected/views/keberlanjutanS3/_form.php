...
<div class="row tiny">
	...
	<div class="row tiny">
		<?php echo $form->labelEx($model,'dana_sumber_selain_mahasiswa'); ?>
		<?php echo $form->error($model,'dana_sumber_selain_mahasiswa'); ?>
		<?php // echo $form->textArea($model,'dana_sumber_selain_mahasiswa',array('rows'=>6, 'cols'=>50,'class'=>'input-xxlarge')); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'dana_sumber_selain_mahasiswa',
                'editorTemplate'=>'full',
                'htmlOptions'=>array(
                					'class'=>'input-xxlarge tinymce'
                					),
