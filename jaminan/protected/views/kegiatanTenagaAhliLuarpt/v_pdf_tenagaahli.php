...
<p>
	...
	4.5.1 Kegiatan tenaga ahli/pakar dari luar PT (tidak termasuk dosen tidak tetap) sebagai pembicara dalam seminar/pelatihan, sebagai pembicara tamu dsb. di program studi ini.
</p>
<?php
if(empty($data)){
	?>
