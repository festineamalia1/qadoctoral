...
<!-- end tambahan -->
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'jenis_kemampuan',array('pengembangan diri'=>'Pengembangan Diri','kerjasama'=>'Kerjasama','komunikasi'=>'Komunikasi','TI'=>'TI','bahasa'=>'Bahasa','keahlian'=>'Keahlian','integritas'=>'Integritas','kepemimpinan'=>'Kepemimpinan','wawasan'=>'Wawasan'),array('prompt' => 'Pilih Jenis Kemampuan')); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'pemanfaatan_hs'); ?>
		<?php echo $form->error($model,'pemanfaatan_hs'); ?>
		<?php echo $form->textArea($model,'pemanfaatan_hs',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
	</div>
