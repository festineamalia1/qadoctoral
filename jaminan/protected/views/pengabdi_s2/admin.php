...
$this->breadcrumbs=array(
	...
	'Standar 7 (Hasil/dampak kegiatan pelayanan/pengabdian kepada masyarakat)'=>array('index'),
	'Manajemen Data',
);
...
$('.search-form form').submit(function(){
	$('#pengabdi-s2-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Kegiatan pelayanan/pengabdian kepada masyarakat</h1>
<?
