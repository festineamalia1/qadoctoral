...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'penataan_pelaksanaan'); ?>
		<?php //echo $form->textArea($model,'penataan_pelaksanaan',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'penataan_pelaksanaan'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'penataan_pelaksanaan',
                'editorTemplate'=>'full',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'peninjauan_kurikulum'); ?>
		<?php //echo $form->textArea($model,'peninjauan_kurikulum',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'peninjauan_kurikulum'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'peninjauan_kurikulum',
                'editorTemplate'=>'full',
                'htmlOptions'=>array('class'=>'input-xxlarge tinymce'),
                'options' => array(
	               'theme_advanced_buttons1' =>
