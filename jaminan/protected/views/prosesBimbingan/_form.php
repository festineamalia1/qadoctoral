...
<!-- end tambahan -->
	...
	<div class="row">
		<?php echo $form->labelEx($model,'kebijakan_pembimbingan'); ?>
		<?php //echo $form->textArea($model,'kebijakan_pembimbingan',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'mekanisme_penunjukkan'); ?>
		<?php //echo $form->textArea($model,'mekanisme_penunjukkan',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'mekanisme_penunjukkan'); ?>
		<?php $this->widget('application.extensions.tinymce.ETinyMce', 
			array(
				'model'=>$model,
				'attribute'=>'mekanisme_penunjukkan',
                'editorTemplate'=>'full',
                'htmlOptions'=>array('class'=>'input-xxlarge tinymce'),
                'options' => array(
	               'theme_advanced_buttons1' =>
	...
	<br><br>
	<div class="row">
		<?php echo $form->labelEx($model,'proses_pembimbingan'); ?>
		<?php //echo $form->textArea($model,'proses_pembimbingan',array('class'=>'input-xxlarge','rows'=>6, 'cols'=>50)); ?>
