...
<div class="row-fluid">
	...
	<div class="span2" style="text-align:center;">
		<a href="<?=Yii::app()->getBaseUrl(true)?>/RekruitmenMaba/admin" title="Kemahasiswaan dan Lulusan">
			<div class="box_menu">
...
<div class="row-fluid">
	...
	<div class="span2" style="text-align:center;">
		<a href="<?=Yii::app()->getBaseUrl(true)?>/agendadanpenelitia/admin" title="Penelitian, Pelayanan/ Pengabdian Kepada Masyarakat, dan Kerjasama">
			<div class="box_menu">
				<img src="<?=Yii::app()->getBaseUrl(true)?>/file/MenuManajemen/Rencana-Studi.gif" style="float:left;width:100%;"> <br>
