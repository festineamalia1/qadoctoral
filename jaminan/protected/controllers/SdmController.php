...
class SdmController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'getdata_dosentidaktetap','getdataupaya','getdata_tenagakependidikan'),
	...
	public function actionSentData(){
	    ...
	    ->select('t.id_prodi,t.rekrut_seleksi,t.penempatan,t.pengembangan
	    	,t.pembinaan,t.berhenti_dosen,t.berhenti_kependidikan,p.jurusan,t.lampiran')
	    ->from('sdm t')
	...
	public function actionCetakPDFSeleksi_pengembangan(){
		...
		$data['data'] = array();
		$data['data'] = Yii::app()->db->createCommand()
	    ->select('t.id_prodi,t.rekrut_seleksi,t.penempatan,t.pengembangan,t.pembinaan,t.berhenti_dosen, t.berhenti_kependidikan, p.jurusan, a.th_akreditasi')
	    ->from('sdm t')
	    ->join('prodi p', 't.id_prodi=p.id_prodi')
	    ->join('administrasi a', 't.id_administrasi=a.id_administrasi')
	    ->andWhere('t.id_prodi=:id', array(':id'=>$id_prodi))
        ...
        if($id_prodi == 1){
        	...
        	// footer
        	$mPDF1->SetHTMLFooter('<p style="padding-top:5px;border-top:1px solid black;width:100%;text-align:left;font-size:11px;font-weight:bold;">BAN-PT : Borang Akreditasi Program Studi Doktoral '.$data["data"]["th_akreditasi"].'</p>');
        	# renderPartial (only 'view' of current controller)
