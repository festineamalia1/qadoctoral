...
class HasilKarya_psController extends Controller
{
	/**
	...
	{
		$model=new HasilKarya_ps;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['HasilKarya_ps']))
		{
			$model->attributes=$_POST['HasilKarya_ps'];
			if($model->save()){
	...
	{	
		...
		$dataProvider=new CActiveDataProvider('HasilKarya_ps',
			array(
				'criteria'=>$criteria,
				'pagination'=>array(
			        'pageSize'=>10,
	...
	{	
		...
		$model=new HasilKarya_ps('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HasilKarya_ps']))
			$model->attributes=$_GET['HasilKarya_ps'];
	 ...
	 * @return HasilKarya_ps the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=HasilKarya_ps::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param HasilKarya_ps $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hasil-karya-ps-form')
		{
