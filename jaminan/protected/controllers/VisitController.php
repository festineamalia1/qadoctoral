...
class VisitController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('admin','delete','update','create','index','view','getdata_visit','sentdata_visit','CetakPDFvisit'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Visit']))
		{
			...
			if($model->save()){
				...
				$this->redirect(array('view','id'=>$model->id_visit));
			}
			// end tambahan
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Visit']))
		{
			...
			if($model->save()){
				...
				// $model->lampiran->saveAs(Yii::app()->basePath.'/../file/Visit/'.$nama);
				$this->redirect(array('view','id'=>$model->id_visit));
			}
			// end tambahan
		}
	...
	public function actionGetData_visit(){
	...
	// 	if(Yii::app()->user->group_id == 1){
		...
		$this->render('v_getdata_visit',$data);
	}

	public function actionSentData_visit(){
		...
		->andWhere('k.id_prodi=:id', array(':id'=>$id_prodi))
		...
		// var_dump($data['data']);
		$myHtml = $this->renderPartial('v_visit',$data,true); 
		echo $myHtml;
		Yii::app()->end(); 
		return;	
	}	

	public function actionCetakPDFvisit(){
        ...
        if($id_prodi == 1){
	        ...
	        $mPDF1->WriteHTML($this->renderPartial('v_pdf_visit_fakultas', $data, true));
        }else{
        	// footer
        	...
        	# renderPartial (only 'view' of current controller)
	        $mPDF1->WriteHTML($this->renderPartial('v_pdf_visit', $data, true));
        }
