...
class PenjelasanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('admin','delete','update','create','index','view','sentdata','cetakPDF'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['penjelasan'];
			if($model->save()){
	...
	{	
		...
		$dataProvider=new CActiveDataProvider('penjelasan'
			,
			array(
				'criteria'=>$criteria,
				'pagination'=>array(
	...
	{
		$model=new penjelasan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['penjelasan']))
			$model->attributes=$_GET['penjelasan'];
	 ...
	 * @return penjelasan the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=penjelasan::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param penjelasan $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='penjelasan-form')
		{
