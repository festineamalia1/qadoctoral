	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('admin','delete','create','index','view','getdata','getdata_evaluasi','sentData','cetakPDFevaluasi'),
...
*/
	public function actionSentData(){
		...
		foreach ($dt['pelacakan'] as $key => $value) {
			...
			}else if($value['jenis_kemampuan'] == 'wawasan'){
				$data['pelacakan']['wawasan'][] = $value;
			}else if($value['jenis_kemampuan'] == 'kepemimpinan'){
				$data['pelacakan']['kepemimpinan'][] = $value;
			}
		}
		// merangkum detail 
	 ...
	 public function actionCetakPDFevaluasi(){
        ...
        if($id_prodi == 1){
        	// footer
        	$mPDF1->SetHTMLFooter('<p style="padding-top:5px;border-top:1px solid black;width:100%;text-align:left;font-size:11px;font-weight:bold;">BAN-PT : Portofolio Fakultas/ Sekolah Tinggi, Akreditasi PS Magister '.$th_akreditasi.'</p>');
