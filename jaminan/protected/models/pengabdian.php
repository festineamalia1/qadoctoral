 ...
 * @property integer $waktu_ts3
 * @property integer $waktu_ts4
 *
 * The followings are the available model relations:
 * @property Prodi $idProdi
 * @property Administrasi $idAdministrasi
 */
class pengabdian extends CActiveRecord
{
	 ...
	 * @return pengabdian the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_administrasi, id_prodi, waktu_ts, waktu_ts1, waktu_ts2, waktu_ts3, waktu_ts4,  jumlah_kegiatan, mhsiswa_terlibat_kegiatan, id_sumber_data', 'numerical', 'integerOnly'=>true),
			...
			array('th_akademik_search, nama_prodi_search,id_pengabdian, id_administrasi, id_prodi, sumber_biaya, waktu_ts, waktu_ts1, waktu_ts2, waktu_ts3, waktu_ts4, jumlah_kegiatan, mhsiswa_terlibat_kegiatan, judul_pengabdian, id_sumber_data, sumber_data, lampiran, detail_sumber_biaya', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'waktu_ts3' => 'Jumlah Penelitian/PKM pd TS3',
			'waktu_ts4' => 'Jumlah Penelitian/PKM pd TS4',
	...
	public function search()
	{
		...
		$criteria->compare('waktu_ts3',$this->waktu_ts3);
		$criteria->compare('waktu_ts4',$this->waktu_ts4);
