 ...
 *
 * The followings are the available columns in table 'pakar':
 * @property integer $id_pakar
 ...
 */
class Pakar extends CActiveRecord
{
	// tambahan
	 ...
	 * @return Pakar the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, nama_lembaga, kurun_waktu, tingkat, sebagai','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			...
			array('nama_dosen_search,th_akademik_search, nama_prodi_search,id_pakar, id_prodi, id_administrasi, id_dosen, nama_lembaga, kurun_waktu, tingkat, sebagai, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'lampiran' => 'Lampiran File (Format nama file harus : Pakar_tahunakreditasi (.zip) contoh Pakar_2012.zip)',
	...
	public function search()
	{
		...
		$criteria->compare('id_pakar',$this->id_pakar);
