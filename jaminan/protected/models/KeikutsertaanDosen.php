...
class KeikutsertaanDosen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_dosen_search, th_akademik_search, nama_prodi_search,id_keikutsertaan_dosen, id_prodi, id_administrasi, id_dosen, nama_lembaga, kurun_waktu, tingkat, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
