...
class KegiatanTenagaAhliLuarpt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, nama_pakar, nama_kegiatan, judul_kegiatan, sebagai, waktu','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('nama_pakar, judul_kegiatan, nama_kegiatan', 'length', 'max'=>500),
			array('sebagai', 'length', 'max'=>500),
	...
	public function attributeLabels()
	{
		return array(
			...
			'nama_pakar' => 'Nama Pakar / Tenaga Ahli',
			'nama_kegiatan' => 'Nama Kegiatan',
			'judul_kegiatan' => 'Judul Kegiatan',
			'sebagai' => ' Peran Sebagai',
			'waktu' => 'Waktu',
