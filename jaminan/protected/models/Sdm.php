...
class Sdm extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, rekrut_seleksi, penempatan, pengembangan, pembinaan, berhenti_dosen, berhenti_kependidikan, 
			...
			array('ket_tambahan', 'length', 'max'=>100),
			//tambahan
			array('lampiran', 'file', 'types'=>'zip','allowEmpty' => true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('th_akademik_search, nama_prodi_search,id_sdm, id_prodi, id_administrasi, rekrut_seleksi, penempatan, pengembangan, pembinaan, berhenti_dosen, berhenti_kependidikan, monitoring, evaluasi, rekam_jejak, ket_tambahan, sumber_data', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pembinaan',$this->pembinaan,true);
