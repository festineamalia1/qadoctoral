...
/**
 * This is the model class for table "jml_mahasiswa_s3".
 *
 * The followings are the available columns in table 'jml_mahasiswa_s3':
 * @property integer $id_jml_mhs_s3
 ...
 * @property integer $rata_lama_studi
 *
 * The followings are the available model relations:
 * @property Prodi $idProdi
 * @property Administrasi $idAdministrasi
 */
class JmlMahasiswaS3 extends CActiveRecord
{
	 ...
	 * @return JmlMahasiswaS3 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, tahun_akademik, daya_tampung, jml_ikut_seleksi, jml_lolos_seleksi, jml_maba, jml_maba_transfer, jml_total, jml_total_transfer, jml_lulusan, jml_lulusan_transfer, ipk_min, ipk_max, ipk_rata, jml_mhs_wna, rata_lama_studi', 'required'),
			array('id_prodi, id_administrasi, daya_tampung, jml_ikut_seleksi, jml_lolos_seleksi, jml_maba, jml_maba_transfer, jml_total, jml_total_transfer, jml_lulusan, jml_lulusan_transfer, ipk_min, ipk_max, ipk_rata, jml_mhs_wna, rata_lama_studi', 'numerical', 'integerOnly'=>true),
			array('tahun_akademik', 'length', 'max'=>4),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('nama_prodi_search,th_akademik_search,id_jml_mhs_s3, id_prodi, id_administrasi, tahun_akademik, daya_tampung, jml_ikut_seleksi, jml_lolos_seleksi, jml_maba, jml_maba_transfer, jml_total, jml_total_transfer, jml_lulusan, jml_lulusan_transfer, ipk_min, ipk_max, ipk_rata, jml_mhs_wna, rata_lama_studi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_jml_mhs_s3',$this->id_jml_mhs_s3);
