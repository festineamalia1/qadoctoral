...
class KegiatanDosen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, jenis_kegiatan, tempat, waktu, sebagai','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			...
			array('nama_dosen_search,th_akademik_search, nama_prodi_search,id_kegiatan_dosen, id_prodi, id_administrasi, id_dosen, jenis_kegiatan, tempat, waktu, sebagai, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
