...
<p> Data dosen tetap yang bidang keahliannya diluar bidang PS</p>
<div class="row-fluid">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	<li class="list_tab "><a href="#tab1" class="a_tab" data-toggle="tab">Sesuai Bidang</a></li>
		    	<li class="list_tab active"><a href="#tab2" class="b_tab" data-toggle="tab">Di Luar Bidang</a></li>
