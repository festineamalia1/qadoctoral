...
/**
 * This is the model class for table "himpunan_alumni_s2".
 *
 * The followings are the available columns in table 'himpunan_alumni_s2':
 * @property integer $id_himpunans2
 ...
 */
class HimpunanAlumniS2 extends CActiveRecord
{
	 ...
	 * @return HimpunanAlumniS2 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_prodi_search,th_akademik_search,id_himpunans2, id_prodi, id_administrasi, himpunan_alumni, sumbangan_dana, sumbangan_fasilitas, masukan_perbaikan_pembelajaran, pengembangan_jejaring, hasil_kegiatan, sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_himpunans2',$this->id_himpunans2);
