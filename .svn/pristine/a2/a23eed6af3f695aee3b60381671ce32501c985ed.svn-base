	...
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_monitoring">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatamonitoring"><i class="icon-arrow-right icon-white"></i>Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
	 $(".getdatamonitoring").click(function()
  	{
  		var dataserialized = $('#form_monitoring').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataMonitoring",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatamonitoring").trigger('click');
