	...
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
		    	<li class="list_tab active"><a href="#tab1" class="a_tab" data-toggle="tab">Data Dosen Tetap Sesuai Bidang</a></li>
		    	<li class="list_tab "><a href="#tab2" class="b_tab" data-toggle="tab">Data Dosen Tetap Diluar Bidang</a></li>
		    	<li class="list_tab "><a href="#tab3" class="c_tab" data-toggle="tab">Aktivitas Dosen Tetap Persemester</a></li>
