...
/**
 * This is the model class for table "data_mhs_5th".
 *
 * The followings are the available columns in table 'data_mhs_5th':
 * @property integer $id_mhs5
 ...
 */
class DataMhs5 extends CActiveRecord
{
	 ...
	 * @return DataMhs5 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_prodi_search,th_akademik_search,id_mhs5, id_prodi, id_administrasi, TS_jum, value_jumlah, jum_lulusan, sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_mhs5',$this->id_mhs5);
