...
class HasilStudiController extends Controller
{
	...
	{
		$model=new HasilStudi;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['HasilStudi']))
		{
			$model->attributes=$_POST['HasilStudi'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('HasilStudi',
				array(
				'criteria'=>$criteria,
				'pagination'=>array(
			        'pageSize'=>10,
	...
	{
		$model=new HasilStudi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HasilStudi']))
			$model->attributes=$_GET['HasilStudi'];
	 ...
	 * @return HasilStudi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=HasilStudi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param HasilStudi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hasil-studi-form')
		{
