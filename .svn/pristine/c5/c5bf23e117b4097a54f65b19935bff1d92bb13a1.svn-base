 ...
 * @property integer $id_bimbingan_Tesis
...
class BimbinganTa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, pendidikan_tertinggi, jabatan_dosen, jml_ketua, jml_anggota','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, id_dosen, id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('jml_ketua, jml_anggota, jabatan_dosen', 'length', 'max'=>10),
			array('sumber_data, lampiran', 'length', 'max'=>100),
			//tambahan
			array('lampiran', 'file', 'types'=>'zip','allowEmpty' => true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('nama_dosen_search,th_akademik_search, nama_prodi_search,id_bimbingan_Tesis, id_prodi, id_administrasi, id_dosen, pendidikan_tertinggi, jabatan_dosen, jml_ketua, jml_anggota, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_bimbingan_Tesis' => 'Id Bimbingan Tesis',
			'id_prodi' => 'Nama Prodi',
	...
	public function search()
	{
		...
		$criteria->compare('id_bimbingan_Tesis',$this->id_bimbingan_Tesis);
		...
		$criteria->compare('jml_ketua',$this->jml_ketua,true);
