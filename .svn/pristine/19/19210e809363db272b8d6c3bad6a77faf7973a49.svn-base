...
class Tesis3thnController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tesis3thn']))
		{
			$model->attributes=$_POST['Tesis3thn'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_tesis3thn));
		}
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Tesis3thn', 
			array(
				'criteria'=>$criteria,
				'pagination'=>array(
			        'pageSize'=>10,
	...
	{
		$model=new Tesis3thn('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tesis3thn']))
			$model->attributes=$_GET['Tesis3thn'];
	 ...
	 * @return Tesis3thn the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tesis3thn::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tesis3thn $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tesis3thn-form')
		{
