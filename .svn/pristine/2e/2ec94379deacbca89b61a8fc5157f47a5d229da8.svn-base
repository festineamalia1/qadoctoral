...
class TugasBljDosen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prodi, id_administrasi, id_dosen, pendidikan_lanjut, bidang_studi, PT, negara, th_mulai_studi','required','message'=>'<i><span style="color:red">Kolom {attribute} tidak boleh dikosongkan</span></i>'),
			array('id_prodi, id_administrasi, id_dosen id_sumber_data', 'numerical', 'integerOnly'=>true),
			array('PT', 'length', 'max'=>50),
			...
			array('nama_dosen_search,th_akademik_search, nama_prodi_search,id_kemampuan, id_prodi, id_administrasi, id_dosen, pendidikan_lanjut, bidang_studi, PT, negara, th_mulai_studi, sumber_data, id_sumber_data, lampiran', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		// class name for the relations automatically generated below. aaaa
		// tambahan
		return array(
