...
$this->breadcrumbs=array(
	'Kerjasama dengan Instansi Luar Negri',
);
?>
...
<?php
	// $model=new VisiMisi;
?>
<h1>Kerjasama dengan Instansi Luar Negri</h1>
<div class="row-fluid">
	<div class="span12" style="padding:20px;">
		<form class="form-inline" method="post" id="form_kerjasamaluar">
		   <label class="control-label" for="">Jurusan</label>
		    ...
		    <button type="button" class="btn btn-primary getdatakerjasamaluar"><i class="icon-arrow-right icon-white"></i> Tampil</button>
		</form>
	</div>
</div>
<div class="row-fluid">
...
$(function(){
  $(".getdatakerjasamaluar").click(function()
  	{
  		var dataserialized = $('#form_kerjasamaluar').serialize();
  		$("#data").hide();
  		$.ajax({
  			type: 'POST',
  			url:"SentDataKerjasamaluar",
  			data: dataserialized,
		   	beforeSend:function(){
  ...
  $(".getdatakerjasamaluar").trigger('click');
